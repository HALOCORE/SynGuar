// Generated by Bisonc++ V6.01.00 on Tue, 16 Feb 2021 00:45:40 +0800
...
PI__ const s_productionInfo[] = 
{
     ...
     {270, 1}, // 1: module ->  functionlist
     {271, 1}, // 2: functionlist ->  function
     {271, 2}, // 3: functionlist ->  function functionlist
     {272, 6}, // 4: function (T_EQUAL) ->  typedecl identifier paramlist T_EQUAL expression T_END
     {273, 7}, // 5: typedecl (T_DSEMICOLON) ->  identifier T_DSEMICOLON typebasiclist T_LEFT typebasic T_RIGHT T_END
     {277, 2}, // 6: typebasiclist (T_ARROW) ->  typebasic T_ARROW
     {277, 3}, // 7: typebasiclist (T_ARROW) ->  typebasic T_ARROW typebasiclist
     {275, 1}, // 8: paramlist ->  identifier
     {275, 2}, // 9: paramlist ->  identifier paramlist
     {276, 4}, // 10: expression (T_LEFT) ->  T_LEFT identifier expressionlist T_RIGHT
     {276, 1}, // 11: expression (T_NIL) ->  T_NIL
     {276, 1}, // 12: expression (T_ZERO) ->  T_ZERO
     {276, 1}, // 13: expression ->  identifier
     {276, 6}, // 14: expression (T_IF) ->  T_IF expression T_THEN expression T_ELSE expression
     {279, 1}, // 15: expressionlist ->  expression
     {279, 2}, // 16: expressionlist ->  expression expressionlist
     {274, 1}, // 17: identifier (T_IDENTIFIER) ->  T_IDENTIFIER
     {278, 1}, // 18: typebasic (T_TYPE) ->  T_TYPE
     {280, 1}, // 19: module_$ ->  module
};
...
#line 24 "Parser.y"
        ...
        case 2:
#line 27 "Parser.y"
        {d_val__ = new ASTFunctionList(vs__(0), nullptr);}
        break;

        case 3:
#line 28 "Parser.y"
        {d_val__ = new ASTFunctionList(vs__(-1), vs__(0));}
        break;

        case 4:
#line 31 "Parser.y"
        {d_val__ = new ASTFunction(vs__(-5), vs__(-4), vs__(-3), vs__(-1)); }
        break;

        case 5:
#line 34 "Parser.y"
        {d_val__ = new ASTTypeDecl(vs__(-6), vs__(-4), vs__(-2));}
        break;

        case 6:
#line 37 "Parser.y"
        {d_val__ = new ASTTypeBasicList(vs__(-1), nullptr);}
        break;

        case 7:
#line 38 "Parser.y"
        {d_val__ = new ASTTypeBasicList(vs__(-2), vs__(0));}
        break;

        case 8:
#line 41 "Parser.y"
        {d_val__ = new ASTParamList(vs__(0), nullptr);}
        break;

        case 9:
#line 42 "Parser.y"
        {d_val__ = new ASTParamList(vs__(-1), vs__(0));}
        break;

        case 10:
#line 45 "Parser.y"
        {d_val__ = new ASTExpressionFuncApply(vs__(-2), vs__(-1));}
        break;

        case 11:
#line 46 "Parser.y"
        {d_val__ = new ASTExpressionScalar("nil");}
        break;

        case 12:
#line 47 "Parser.y"
        {d_val__ = new ASTExpressionScalar("zero");}
        break;

        case 13:
#line 48 "Parser.y"
        {d_val__ = new ASTExpressionScalar(reinterpret_cast<ASTIdentifier*>(vs__(0))->id);}
        break;

        case 14:
#line 49 "Parser.y"
        {d_val__ = new ASTExpressionIfThenElse(vs__(-4), vs__(-2), vs__(0));}
        break;

        case 15:
#line 52 "Parser.y"
        {d_val__ = new ASTExpressionList(vs__(0), nullptr);}
        break;

        case 16:
#line 53 "Parser.y"
        {d_val__ = new ASTExpressionList(vs__(-1), vs__(0));}
        break;

        case 17:
#line 56 "Parser.y"
        { d_val__ = new ASTIdentifier(std::string(d_scanner.matched()));}
        break;

        case 18:
#line 59 "Parser.y"
        { d_val__ = new ASTTypeBasic(std::string(d_scanner.matched())); }
        break;
